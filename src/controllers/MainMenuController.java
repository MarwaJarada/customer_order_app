...
public class MainMenuController{
    ...
    public void openManageProductView(ActionEvent event) throws IOException {
        openNewScene(this.getClass(),mainMenu,"../view/product_manage.fxml","Manage Product");

    }

    @FXML
    public void openManageCustomerView(ActionEvent event) throws IOException {
        openNewScene(this.getClass(),mainMenu,"../view/customer_manage.fxml","Manage Customer");
    }

    public void openManageOrderView(ActionEvent event) throws IOException {
        openNewStage(this.getClass(),"../view/order_manage.fxml","Manage Order");
        //openNewScene(this.getClass(),mainMenu,"../view/order_manage.fxml");

    }

    public void logout(ActionEvent event) throws IOException {
        openNewScene(this.getClass(),mainMenu,"../view/screen_login.fxml","Login");
    }
